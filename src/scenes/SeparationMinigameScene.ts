...
export class SeparationMinigameScene extends Phaser.Scene {
  ...
  create() {
    ...
    const genericComposites = [
      ...
      'loaded_dog_in_box', 'popcorn_in_box', 'champagne_in_plastic', 'pill_bottle_with_cotton', 'syringe_in_wrapper', 'iv_bag_with_tube', 'bandaid_with_wrapper', 'thermometer_in_case'
    ];
